# Healthcare AI:Medical Imaging - 210471F

## Student Information

- **Index Number:** 210471F
- **Research Area:** Healthcare AI:Medical Imaging
- **GitHub Username:** @Irash-Perera
- **Email:** irash.21@cse.mrt.ac.lk

## Project Structure
```
210471F-Healthcare-AI:Medical-Imaging/
├── README.md                    # This file
├── docs/
...
- `student-210471F` (automatically added)

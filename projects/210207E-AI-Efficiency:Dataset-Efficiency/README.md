# AI Efficiency:Dataset Efficiency - 210207E

## Student Information

- **Index Number:** 210207E
- **Research Area:** AI Efficiency:Dataset Efficiency
- **GitHub Username:** @Janarthanan-Harismenan
- **Email:** janarthanan.21@cse.mrt.ac.lk

## Project Structure
```
210207E-AI-Efficiency:Dataset-Efficiency/
├── README.md                    # This file
├── docs/
...
- `student-210207E` (automatically added)

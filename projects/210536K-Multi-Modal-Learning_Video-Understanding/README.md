# Multi-Modal Learning:Video Understanding - 210536K

## Student Information

- **Index Number:** 210536K
- **Research Area:** Multi-Modal Learning:Video Understanding
- **GitHub Username:** @ThisaraWeerakoon
- **Email:** thisara.21@cse.mrt.ac.lk

## Project Structure
```
210536K-Multi-Modal-Learning:Video-Understanding/
├── README.md                    # This file
├── docs/
...
- `student-210536K` (automatically added)

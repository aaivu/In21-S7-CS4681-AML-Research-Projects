# Human-AI Collab:Decision Support - 210343P

## Student Information

- **Index Number:** 210343P
- **Research Area:** Human-AI Collab:Decision Support
- **GitHub Username:** @Isara-Li
- **Email:** vimandika.21@cse.mrt.ac.lk

## Project Structure
```
210343P-Human-AI-Collab:Decision-Support/
├── README.md                    # This file
├── docs/
...
- `student-210343P` (automatically added)

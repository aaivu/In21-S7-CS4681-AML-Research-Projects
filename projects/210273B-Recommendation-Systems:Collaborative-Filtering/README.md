# Recommendation Systems:Collaborative Filtering - 210273B

## Student Information

- **Index Number:** 210273B
- **Research Area:** Recommendation Systems:Collaborative Filtering
- **GitHub Username:** @lckariyawasam
- **Email:** lakindu.21@cse.mrt.ac.lk

## Project Structure
```
210273B-Recommendation-Systems:Collaborative-Filtering/
├── README.md                    # This file
├── docs/
...
- `student-210273B` (automatically added)

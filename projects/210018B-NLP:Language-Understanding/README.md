# NLP:Language Understanding - 210018B

## Student Information

- **Index Number:** 210018B
- **Research Area:** NLP:Language Understanding
- **GitHub Username:** @SivakumarAbisherk
- **Email:** abisherk.21@cse.mrt.ac.lk

## Project Structure
```
210018B-NLP:Language-Understanding/
├── README.md                    # This file
├── docs/
...
- `student-210018B` (automatically added)

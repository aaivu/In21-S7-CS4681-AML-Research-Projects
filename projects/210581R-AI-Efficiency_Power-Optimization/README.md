# AI Efficiency:Power Optimization - 210581R

## Student Information

- **Index Number:** 210581R
- **Research Area:** AI Efficiency:Power Optimization
- **GitHub Username:** @Sayan-Saba
- **Email:** Sabalingam.21@cse.mrt.ac.lk

## Project Structure
```
210581R-AI-Efficiency:Power-Optimization/
├── README.md                    # This file
├── docs/
...
- `student-210581R` (automatically added)

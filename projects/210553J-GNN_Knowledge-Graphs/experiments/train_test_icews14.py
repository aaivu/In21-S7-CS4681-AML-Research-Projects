...
def load_local_icews(data_dir="data/ICEWS14", valid_ratio=0.01, seed=42):
    ...
    # test = read_file(os.path.join(data_dir, "test.txt"),4344, 7000)
    test = read_file(os.path.join(data_dir, "test.txt"),7000, 8736)
    ...
    num_relation = int(torch.max(all_relations)) + 1  +1 
...
class TemporalKGBenchmark(Dataset):
    ...
    def __init__(self, ds, split="train"):
        ...
        self.num_relation = int(torch.max(all_relations)) + 1 + 1
...
def main(
    ...
    evaluate_only=True,
    checkpoint_path="data/ICEWS14/model_epoch_2.pt",
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data-dir", type=str, default="data/ICEWS14",
    ...
    parser.add_argument("--checkpoint", type=str, default="data/ICEWS14/model_epoch_2.pt",

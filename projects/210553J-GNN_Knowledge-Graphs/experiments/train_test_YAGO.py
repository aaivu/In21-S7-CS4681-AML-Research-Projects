...
def load_local_icews(data_dir="data/YAGO", valid_ratio=0.01, seed=42):
    """
    ...
    full_train = read_file(os.path.join(data_dir, "train.txt") ,0, 177)
    valid = read_file(os.path.join(data_dir, "valid.txt"),178, 182)
    test = read_file(os.path.join(data_dir, "test.txt"),183, 188)
...
def main(
    ...
    evaluate_only=True,
    checkpoint_path="/home/sajeenthiranp/KG/fork/NBFNet/t-nbfnet/data/YAGO/model_epoch_2.pt",
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train or evaluate YAGO temporal model")
    parser.add_argument("--data-dir", type=str, default="data/YAGO",
    ...
    parser.add_argument("--checkpoint", type=str, default="data/YAGO/model_epoch_2.pt",

...
def load_local_icews(data_dir="data/ICEWS18", valid_ratio=0.01, seed=42):
    """
    ...
    full_train = read_file(os.path.join(data_dir, "train.txt") ,0, 5736)
    valid = read_file(os.path.join(data_dir, "valid.txt"),5760, 6456)
    test = read_file(os.path.join(data_dir, "test.txt"),6480, 7272)
...
def main(
    ...
    evaluate_only=False,
    # checkpoint_path="/home/sajeenthiranp/KG/fork/NBFNet/t-nbfnet/data/ICEWS18/model_epoch_2.pt",
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train or evaluate ICEWS temporal model")
    parser.add_argument("--data-dir", type=str, default="data/ICEWS18",
    ...
    parser.add_argument("--checkpoint", type=str, default="data/ICEWS18/model_epoch_2.pt",

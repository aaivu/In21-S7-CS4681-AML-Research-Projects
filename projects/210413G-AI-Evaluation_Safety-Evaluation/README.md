# AI Evaluation:Safety Evaluation - 210413G

## Student Information

- **Index Number:** 210413G
- **Research Area:** AI Evaluation:Safety Evaluation
- **GitHub Username:** @VilashNaveen
- **Email:** vilash.21@cse.mrt.ac.lk

## Project Structure
```
210413G-AI-Evaluation:Safety-Evaluation/
├── README.md                    # This file
├── docs/
...
- `student-210413G` (automatically added)

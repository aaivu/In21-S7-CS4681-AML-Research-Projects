# Recommendation Systems:Collaborative Filtering - 210401T

## Student Information

- **Index Number:** 210401T
- **Research Area:** Recommendation Systems:Collaborative Filtering
- **GitHub Username:** @nethum2001
- **Email:** nethum.21@cse.mrt.ac.lk

## Project Structure
```
210401T-Recommendation-Systems:Collaborative-Filtering/
├── README.md                    # This file
├── docs/
...
- `student-210401T` (automatically added)

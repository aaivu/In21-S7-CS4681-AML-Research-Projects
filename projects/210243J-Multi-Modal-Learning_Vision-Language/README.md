# Multi-Modal Learning:Vision-Language - 210243J

## Student Information

- **Index Number:** 210243J
- **Research Area:** Multi-Modal Learning:Vision-Language
- **GitHub Username:** @sithumjee
- **Email:** sithum.21@cse.mrt.ac.lk

## Project Structure
```
210243J-Multi-Modal-Learning:Vision-Language/
├── README.md                    # This file
├── docs/
...
- `student-210243J` (automatically added)

# 3D Vision:3D Scene Understanding - 200151P

## Student Information

- **Index Number:** 200151P
- **Research Area:** 3D Vision:3D Scene Understanding
- **GitHub Username:** @Buddhima2000
- **Email:** buddhima.20@cse.mrt.ac.lk

## Project Structure
```
200151P-3D-Vision:3D-Scene-Understanding/
├── README.md                    # This file
├── docs/
...
- `student-200151P` (automatically added)

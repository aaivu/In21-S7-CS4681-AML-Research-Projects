...
if __name__ == '__main__':
    ...
    parser.add_argument('--lambda_qce', type=float, default=0.05)
    parser.add_argument('--rounding_tau', type=float, default=0.1)
    ...
    if args.submit == 'no':
        ...
        # Build command without env var prefix
        COMMANDLINE_CLEAN = COMMANDLINE.split('python scripts/train.py')[1]
        COMMANDLINE_CLEAN = 'python scripts/train.py' + COMMANDLINE_CLEAN
        
        print("Executing:", COMMANDLINE_CLEAN)
        os.system(COMMANDLINE_CLEAN)

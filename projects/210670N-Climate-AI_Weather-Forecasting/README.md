# Climate AI:Weather Forecasting - 210670N

## Student Information

- **Index Number:** 210670N
- **Research Area:** Climate AI:Weather Forecasting
- **GitHub Username:** @OmalyaV
- **Email:** omalya.21@cse.mrt.ac.lk

## Project Structure
```
210670N-Climate-AI:Weather-Forecasting/
├── README.md                    # This file
├── docs/
...
- `student-210670N` (automatically added)

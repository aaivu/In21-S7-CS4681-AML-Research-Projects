# Recommendation Systems:Collaborative Filtering - 210266G

## Student Information

- **Index Number:** 210266G
- **Research Area:** Recommendation Systems:Collaborative Filtering
- **GitHub Username:** @kaushalkahapola
- **Email:** kaushal.21@cse.mrt.ac.lk

## Project Structure
```
210266G-Recommendation-Systems:Collaborative-Filtering/
├── README.md                    # This file
├── docs/
...
- `student-210266G` (automatically added)

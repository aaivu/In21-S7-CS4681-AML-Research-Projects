...
# === New training QoL flags ===
parser.add_argument('--amp', action='store_true',
                    help='Enable mixed precision training (CUDA only)')
parser.add_argument('--patience', type=int, default=10,
                    help='Early stopping patience (epochs)')
parser.add_argument('--lr_patience', type=int, default=5,
                    help='LR scheduler patience for ReduceLROnPlateau')
parser.add_argument('--balance_sampler', action='store_true',
                    help='Use WeightedRandomSampler on train split')
parser.add_argument('--focal', action='store_true',
                    help='Use focal loss instead of BCEWithLogits')
parser.add_argument('--focal_gamma', type=float, default=1.5,
                    help='Focal loss gamma (use this instead of --gamma)')

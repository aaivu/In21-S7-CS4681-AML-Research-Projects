# GNN:Citation Networks - 210110B

## Student Information

- **Index Number:** 210110B
- **Research Area:** GNN:Citation Networks
- **GitHub Username:** @vinukaveesha
- **Email:** vinu.21@cse.mrt.ac.lk

## Project Structure
```
210110B-GNN:Citation-Networks/
├── README.md                    # This file
├── docs/
...
- `student-210110B` (automatically added)

# Reasoning AI:Mathematical Reasoning - 210588U

## Student Information

- **Index Number:** 210588U
- **Research Area:** Reasoning AI:Mathematical Reasoning
- **GitHub Username:** @senaMora
- **Email:** udantha.21@cse.mrt.ac.lk

## Project Structure
```
210588U-Reasoning-AI:Mathematical-Reasoning/
├── README.md                    # This file
├── docs/
...
- `student-210588U` (automatically added)

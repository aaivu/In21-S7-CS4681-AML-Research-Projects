# RL:Multi-Agent RL - 210404F

## Student Information

- **Index Number:** 210404F
- **Research Area:** RL:Multi-Agent RL
- **GitHub Username:** @harithmaduranga
- **Email:** harith.21@cse.mrt.ac.lk

## Project Structure
```
210404F-RL:Multi-Agent-RL/
├── README.md                    # This file
├── docs/
...
- `student-210404F` (automatically added)

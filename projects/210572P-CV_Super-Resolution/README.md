# CV:Super Resolution - 210572P

## Student Information

- **Index Number:** 210572P
- **Research Area:** CV:Super Resolution
- **GitHub Username:** @SanjanaChamindu
- **Email:** yoshan.21@cse.mrt.ac.lk

## Project Structure
```
210572P-CV:Super-Resolution/
├── README.md                    # This file
├── docs/
...
- `student-210572P` (automatically added)

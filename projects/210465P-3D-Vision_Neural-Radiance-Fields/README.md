# 3D Vision:Neural Radiance Fields - 210465P

## Student Information

- **Index Number:** 210465P
- **Research Area:** 3D Vision:Neural Radiance Fields
- **GitHub Username:** @https://gitlab.com/primafyr
- **Email:** dulina.21@cse.mrt.ac.lk

## Project Structure
```
210465P-3D-Vision:Neural-Radiance-Fields/
├── README.md                    # This file
├── docs/
...
- `student-210465P` (automatically added)

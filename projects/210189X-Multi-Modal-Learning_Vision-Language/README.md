# Multi-Modal Learning:Vision-Language - 210189X

## Student Information

- **Index Number:** 210189X
- **Research Area:** Multi-Modal Learning:Vision-Language
- **GitHub Username:** @helithd
- **Email:** helith.21@cse.mrt.ac.lk

## Project Structure
```
210189X-Multi-Modal-Learning:Vision-Language/
├── README.md                    # This file
├── docs/
...
- `student-210189X` (automatically added)

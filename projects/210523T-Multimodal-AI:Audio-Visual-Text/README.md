# Multimodal AI:Audio-Visual-Text - 210523T

## Student Information

- **Index Number:** 210523T
- **Research Area:** Multimodal AI:Audio-Visual-Text
- **GitHub Username:** @RanaweeraHK
- **Email:** hashini.21@cse.mrt.ac.lk

## Project Structure
```
210523T-Multimodal-AI:Audio-Visual-Text/
├── README.md                    # This file
├── docs/
...
- `student-210523T` (automatically added)

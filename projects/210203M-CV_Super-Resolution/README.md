# CV:Super Resolution - 210203M

## Student Information

- **Index Number:** 210203M
- **Research Area:** CV:Super Resolution
- **GitHub Username:** @HanaNazir
- **Email:** fathimahana.21@cse.mrt.ac.lk

## Project Structure
```
210203M-CV:Super-Resolution/
├── README.md                    # This file
├── docs/
...
- `student-210203M` (automatically added)

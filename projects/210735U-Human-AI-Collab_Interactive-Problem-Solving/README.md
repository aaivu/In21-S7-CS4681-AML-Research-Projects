# Human-AI Collab:Interactive Problem Solving - 210735U

## Student Information

- **Index Number:** 210735U
- **Research Area:** Human-AI Collab:Interactive Problem Solving
- **GitHub Username:** @Dulmi21
- **Email:** dulmi.21@cse.mrt.ac.lk

## Project Structure
```
210735U-Human-AI-Collab:Interactive-Problem-Solving/
├── README.md                    # This file
├── docs/
...
- `student-210735U` (automatically added)

# GNN:Node Prediction - 210004E

## Student Information

- **Index Number:** 210004E
- **Research Area:** GNN:Node Prediction
- **GitHub Username:** @RaminduA
- **Email:** ramindu.21@cse.mrt.ac.lk

## Project Structure
```
210004E-GNN:Node-Prediction/
├── README.md                    # This file
├── docs/
...
- `student-210004E` (automatically added)

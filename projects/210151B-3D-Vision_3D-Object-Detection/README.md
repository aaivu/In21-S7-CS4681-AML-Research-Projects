# 3D Vision:3D Object Detection - 210151B

## Student Information

- **Index Number:** 210151B
- **Research Area:** 3D Vision:3D Object Detection
- **GitHub Username:** @PASINDU151
- **Email:** pasindud.21@cse.mrt.ac.lk

## Project Structure
```
210151B-3D-Vision:3D-Object-Detection/
├── README.md                    # This file
├── docs/
...
- `student-210151B` (automatically added)

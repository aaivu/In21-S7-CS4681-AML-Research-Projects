...
class Task2Env(gym.Env):
    ...
    def __init__(
        ...
        self.strong_negative_return = (
            -0.02
        )  # Below -2% return considered strong negative
        ...
        self.highest_negative_reward = (
            -2.0
        )  # Strong penalty for confident wrong decisions
        self.negative_reward = -1.0  # Standard penalty for wrong decisions
        self.weak_negative_reward = (
            -0.5
        )  # Lesser penalty for less confident wrong decisions

        self.high_confidence = (
            6  # Confidence level above which actions are considered highly confident
        )
        ...
        self.moderate_negative_reward = (
            -0.1
        )  # Small negative reward for minor wrong actions
    ...
    def _evaluate_model(self, actions):
        """
        Strategy to evaluate the LLM-generated sentiment score.

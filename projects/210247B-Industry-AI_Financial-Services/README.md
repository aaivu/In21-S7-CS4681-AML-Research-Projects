# Industry AI:Financial Services - 210247B

## Student Information

- **Index Number:** 210247B
- **Research Area:** Industry AI:Financial Services
- **GitHub Username:** @Chamikajaya
- **Email:** chamika.21@cse.mrt.ac.lk

## Project Structure
```
210247B-Industry-AI:Financial-Services/
├── README.md                    # This file
├── docs/
...
- `student-210247B` (automatically added)

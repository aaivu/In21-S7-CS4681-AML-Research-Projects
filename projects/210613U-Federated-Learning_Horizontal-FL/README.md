# Federated Learning:Horizontal FL - 210613U

## Student Information

- **Index Number:** 210613U
- **Research Area:** Federated Learning:Horizontal FL
- **GitHub Username:** @Chirantha01
- **Email:** chirantha.21@cse.mrt.ac.lk

## Project Structure
```
210613U-Federated-Learning:Horizontal-FL/
├── README.md                    # This file
├── docs/
...
- `student-210613U` (automatically added)

# Multi-Modal Learning\- Vision-Language - 210417X

## Student Information

- **Index Number:** 210417X
- **Research Area:** Multi-Modal Learning\- Vision-Language
- **GitHub Username:** @Nayanatharapmc
- **Email:** chethmi.21@cse.mrt.ac.lk

## Project Structure
```
210417X-Multi-Modal-Learning\--Vision-Language/
├── README.md                    # This file
├── docs/
...
- `student-210417X` (automatically added)

# AI Efficiency:Federated Learning - 210055J

## Student Information

- **Index Number:** 210055J
- **Research Area:** AI Efficiency:Federated Learning
- **GitHub Username:** @SaviNimz
- **Email:** nimetha.21@cse.mrt.ac.lk

## Project Structure
```
210055J-AI-Efficiency:Federated-Learning/
├── README.md                    # This file
├── docs/
...
- `student-210055J` (automatically added)

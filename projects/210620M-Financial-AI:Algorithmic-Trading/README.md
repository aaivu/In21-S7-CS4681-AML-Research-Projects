# Financial AI:Algorithmic Trading - 210620M

## Student Information

- **Index Number:** 210620M
- **Research Area:** Financial AI:Algorithmic Trading
- **GitHub Username:** @Lason360
- **Email:** lasana.21@cse.mrt.ac.lk

## Project Structure
```
210620M-Financial-AI:Algorithmic-Trading/
├── README.md                    # This file
├── docs/
...
- `student-210620M` (automatically added)

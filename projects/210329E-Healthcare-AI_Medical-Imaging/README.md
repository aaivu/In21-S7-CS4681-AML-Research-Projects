# Healthcare AI:Medical Imaging - 210329E

## Student Information

- **Index Number:** 210329E
- **Research Area:** Healthcare AI:Medical Imaging
- **GitHub Username:** @YasiruLaksara
- **Email:** yasirul.21@cse.mrt.ac.lk

## Project Structure
```
210329E-Healthcare-AI:Medical-Imaging/
├── README.md                    # This file
├── docs/
...
- `student-210329E` (automatically added)

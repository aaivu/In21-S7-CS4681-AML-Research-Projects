# CV:Semantic Segmentation - 210372D

## Student Information

- **Index Number:** 210372D
- **Research Area:** CV:Semantic Segmentation
- **GitHub Username:** @CharanaManawathilake
- **Email:** charana.21@cse.mrt.ac.lk

## Project Structure
```
210372D-CV:Semantic-Segmentation/
├── README.md                    # This file
├── docs/
...
- `student-210372D` (automatically added)

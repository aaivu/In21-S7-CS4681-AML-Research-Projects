# NLP:Question Answering - 210333K

## Student Information

- **Index Number:** 210333K
- **Research Area:** NLP:Question Answering
- **GitHub Username:** @lakshanpd
- **Email:** dhanuka.21@cse.mrt.ac.lk

## Project Structure
```
210333K-NLP:Question-Answering/
├── README.md                    # This file
├── docs/
...
- `student-210333K` (automatically added)

# AI Safety:Interpretability - 210647C

## Student Information

- **Index Number:** 210647C
- **Research Area:** AI Safety:Interpretability
- **GitHub Username:** @disini-thev
- **Email:** disini.21@cse.mrt.ac.lk

## Project Structure
```
210647C-AI-Safety:Interpretability/
├── README.md                    # This file
├── docs/
...
- `student-210647C` (automatically added)

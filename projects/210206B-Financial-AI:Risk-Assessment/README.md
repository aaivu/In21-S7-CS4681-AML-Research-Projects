# Financial AI:Risk Assessment - 210206B

## Student Information

- **Index Number:** 210206B
- **Research Area:** Financial AI:Risk Assessment
- **GitHub Username:** @harikishnanavaratnam
- **Email:** navaratnam.21@cse.mrt.ac.lk

## Project Structure
```
210206B-Financial-AI:Risk-Assessment/
├── README.md                    # This file
├── docs/
...
- `student-210206B` (automatically added)

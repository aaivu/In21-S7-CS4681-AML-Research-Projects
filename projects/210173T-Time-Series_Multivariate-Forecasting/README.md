# Time Series:Multivariate Forecasting - 210173T

## Student Information

- **Index Number:** 210173T
- **Research Area:** Time Series:Multivariate Forecasting
- **GitHub Username:** @deshithagallage
- **Email:** deshitha.21@cse.mrt.ac.lk

## Project Structure
```
210173T-Time-Series:Multivariate-Forecasting/
├── README.md                    # This file
├── docs/
...
- `student-210173T` (automatically added)

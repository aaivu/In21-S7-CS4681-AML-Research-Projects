# Edge AI:Model Compression - 210450P

## Student Information

- **Index Number:** 210450P
- **Research Area:** Edge AI:Model Compression
- **GitHub Username:** @ThiwankaRoshen
- **Email:** thiwanka.21@cse.mrt.ac.lk

## Project Structure
```
210450P-Edge-AI:Model-Compression/
├── README.md                    # This file
├── docs/
...
- `student-210450P` (automatically added)

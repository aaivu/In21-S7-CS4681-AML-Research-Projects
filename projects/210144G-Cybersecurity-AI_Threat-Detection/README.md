# Cybersecurity AI:Threat Detection - 210144G

## Student Information

- **Index Number:** 210144G
- **Research Area:** Cybersecurity AI:Threat Detection
- **GitHub Username:** @NisithDivantha
- **Email:** nisith.21@cse.mrt.ac.lk

## Project Structure
```
210144G-Cybersecurity-AI:Threat-Detection/
├── README.md                    # This file
├── docs/
...
- `student-210144G` (automatically added)

# NLP:Speech Recognition - 210163M

## Student Information

- **Index Number:** 210163M
- **Research Area:** NLP:Speech Recognition
- **GitHub Username:** @PraminthaFernando
- **Email:** dasun.21@cse.mrt.ac.lk

## Project Structure
```
210163M-NLP:Speech-Recognition/
├── README.md                    # This file
├── docs/
...
- `student-210163M` (automatically added)

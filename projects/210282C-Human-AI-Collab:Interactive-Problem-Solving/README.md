# Human-AI Collab:Interactive Problem Solving - 210282C

## Student Information

- **Index Number:** 210282C
- **Research Area:** Human-AI Collab:Interactive Problem Solving
- **GitHub Username:** @KavindaCSE
- **Email:** subavarshanaa.21@cse.mrt.ac.lk

## Project Structure
```
210282C-Human-AI-Collab:Interactive-Problem-Solving/
├── README.md                    # This file
├── docs/
...
- `student-210282C` (automatically added)

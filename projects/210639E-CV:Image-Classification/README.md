# CV:Image Classification - 210639E

## Student Information

- **Index Number:** 210639E
- **Research Area:** CV:Image Classification
- **GitHub Username:** @mohamedTheesan21
- **Email:** theesan.21@cse.mrt.ac.lk

## Project Structure
```
210639E-CV:Image-Classification/
├── README.md                    # This file
├── docs/
...
- `student-210639E` (automatically added)

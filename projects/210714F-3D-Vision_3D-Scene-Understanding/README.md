# 3D Vision:3D Scene Understanding - 210714F

## Student Information

- **Index Number:** 210714F
- **Research Area:** 3D Vision:3D Scene Understanding
- **GitHub Username:** @tharindu-wijekoon
- **Email:** tharinduw.21@cse.mrt.ac.lk

## Project Structure
```
210714F-3D-Vision:3D-Scene-Understanding/
├── README.md                    # This file
├── docs/
...
- `student-210714F` (automatically added)

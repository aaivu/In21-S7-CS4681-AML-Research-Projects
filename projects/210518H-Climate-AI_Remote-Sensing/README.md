# Climate AI:Remote Sensing - 210518H

## Student Information

- **Index Number:** 210518H
- **Research Area:** Climate AI:Remote Sensing
- **GitHub Username:** @k-ranasinghe
- **Email:** kumudh.21@cse.mrt.ac.lk

## Project Structure
```
210518H-Climate-AI:Remote-Sensing/
├── README.md                    # This file
├── docs/
...
- `student-210518H` (automatically added)

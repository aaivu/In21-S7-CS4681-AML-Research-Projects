...
from data_loader.MultiScaleEgoClip_dataset import MultiScaleEgoClip_EgoMCQ
...
def dataset_loader(dataset_name,
    ...
    elif dataset_name == "MultiScaleEgoClip":
        # Extract multi_scale_frames from kwargs if provided
        multi_scale_frames = kwargs.pop('multi_scale_frames', [4, 8, 16])
        dataset = MultiScaleEgoClip_EgoMCQ(multi_scale_frames=multi_scale_frames, **kwargs)

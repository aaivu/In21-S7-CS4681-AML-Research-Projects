# Multi-Modal Learning:Vision-Language - 210299J

## Student Information

- **Index Number:** 210299J
- **Research Area:** Multi-Modal Learning:Vision-Language
- **GitHub Username:** @VeroshaKriyanjala
- **Email:** verosha.21@cse.mrt.ac.lk

## Project Structure
```
210299J-Multi-Modal-Learning:Vision-Language/
├── README.md                    # This file
├── docs/
...
- `student-210299J` (automatically added)

...
class GMF(nn.Module):
    ...
    def forward(self, user_indices, item_indices):
        ...
        vector = user_latent * item_latent
...
if __name__ == '__main__':
    ...
    model_out_file = 'Pretrain/%s_GMF_%d_%d.pt' % (args.dataset, num_factors, int(time()))
    ...
    model = GMF(num_users, num_items, num_factors, regs).to(device)

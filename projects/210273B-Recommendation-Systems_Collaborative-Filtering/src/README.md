...
Orignally the authors had used Keras with Theano as the backend. 
- Keras version:  '1.0.7'
- Theano version: '0.8.0'
[Original Repo](https://github.com/hexiangnan/neural_collaborative_filtering)

Given the use of legacy packages, I updated the implemenation to use Pytorch.
